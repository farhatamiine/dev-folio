...
function Template1({username}: Template1Props) {
    return (
        <main className={"bg-slate-200 h-full w-full relative"}>
            ...
            <div
                ...
                <div className={"flex items-center justify-center flex-col"}>
                    <img src="me.jpg" alt="" className={"w-40 h-40 rounded-full border-2 border-black"}/>
                    ...
                    <p className={"text-xl md:text-2xl bg-clip-text text-center  md:w-[40rem] font-medium"}>
                        Designing and developing visually stunning and technically proficient websites
